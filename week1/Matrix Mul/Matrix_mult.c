...
int main()
{
    ...
    int R=3;  //Enter the no. of rows of matrix 1
    int C=4;  //Enter the no. of columns of matrix 1
    int R1=4; //Enter the no. of rows of matrix 2
    int C1=3;  //Enter the no. of columns of matrix 2
    int mat1[R][C];
    int mat2[R1][C1];
    int mat[R][C1];
